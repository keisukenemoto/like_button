...
if ($_REQUEST['action'] == ['rewrite']) {
    $_POST = $_SESSION['join']; //からである$_postに入力された内容を復元している
    $error['rewrite'] = true;
}
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <!-- actionが空なのは自分に送信という意味。ファイルの送信フォームがあるなら、必ずenctype="multipart/form-data"を記載 -->
        <dl>
            ...
            <dd>
                ...
                <?php if ($error['image'] == 'type') : ?>
                    <p class=error>*写真などは「.gif」または「.jpgの画像を指定してください</p>
                <?php endif; ?>
                <?php if (!empty($error)) : ?>
